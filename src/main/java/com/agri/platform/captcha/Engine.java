...
public class Engine extends ListImageCaptchaEngine {  
    @Override  
    protected void buildInitialFactories() {  
        int minWordLength = CaptchaCommon.valid_code_length_min;  
        int maxWordLength = CaptchaCommon.valid_code_length_max;  
        int fontSize = CaptchaCommon.valid_code_font_size;  
        int imageWidth = 250;  
        int imageHeight = 100;  
