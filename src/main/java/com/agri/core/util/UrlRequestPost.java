...
public class UrlRequestPost {
	...
	public static void main(String args[]){
		UrlRequestPost.urlPost("http://localhost:8080/BO/UpdateUser.do","{\"user_id\":\"user1\",\"customer_id\":\"999\",\"equipment_id\":\"0003\",\"device_type\":\"0003\"}");
	}
}
